...
<template>
  <div class="mx-auto w-full max-w-xl border-zinc-300 bg-right bg-no-repeat px-14 pb-14 pt-9 text-center md:rounded-3xl md:border">
    <div
    ...
    >
      ...
      <p
        v-if="formError"
        class="mt-4 text-center text-rose-400"
      >
        {{ formError }}
      </p>
    </div>
